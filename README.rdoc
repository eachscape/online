...
*WARNING:* The current version of MockStorage depends on global variables
in SimulatedS3Object, and so you can only create one MockStorage object at
a time.  If you need to test S3 and the CDN at the same time, you'll need
to do some more work on this code.
